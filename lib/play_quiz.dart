...
class _PlayQuizState extends State<PlayQuiz> {
  ...
  QuestionModel getQuestionModelFromDatasnapshot(
    ...
    QuestionModel questionModel =new QuestionModel(
      ...
      option4: "",
      correctOption: "",
      answered: false, // initially no answer is selected that is why it is false
    );
  ...
  @override
  void initState() { // load pe sb se pehle ye run
    print("${widget.quizId}");
          ...
          onPressed:(){
            Navigator.push(
              ...
              PageRouteBuilder(pageBuilder: (context, animation, _) {
                return Results(correct: _correct, incorrect: _incorrect, total: total);
              },opaque: false),
            );
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        ...
        children: [// index+1 kyu ke qwuestions not start from 0 they start from 1 to6
            ...
            onTap: () {
              if (!widget.questionModel.answered) {
                ...
                if (widget.questionModel.option1 ==
                  ...
                  _correct = _correct + 1;
                  _notAttempted = _notAttempted + 1; // attempted  correctly
                  setState(() {});
                } else {//wrong answer selected
                  optionSelected = widget.questionModel.option1;
                  widget.questionModel.answered = true;
                  _incorrect = _incorrect + 1;
                  _notAttempted = _notAttempted - 1; // it is attempted but answered incorrectly
                  setState(() {});
                }
              }
            },
            child: OptionTile(//hr options ka hai option tile
